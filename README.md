...
[index.html](https://github.com/user-attachments/files/22561014/index.html)
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">[elements.css](https://github.com/user-attachments/files/22561020/elements.css)
[classes.css](https://github.com/user-attachments/files/22561019/classes.css)
[variables.css](https://github.com/user-attachments/files/22561017/variables.css)
[styles.css](https://github.com/user-attachments/files/22561016/styles.css)
[menu.css](https://github.com/user-attachments/files/22561015/menu.css)
![javascriptimg](https://github.com/user-attachments/assets/304abde4-9e6f-4e6c-bad6-d04bf262a4eb)
...
<body>
  ...
  <label class="close-menu-label" for="close-menu"
   tittle="close menu"></label>


    <aside class="menu white-bg">
        <div class="main-content menu-content">
        <h1 onclick="getElementById('close-menu').click()">
            <a href="#home">LOGO</a>
        </h1>

        <nav>
            <ul onclick="getElementById('close-menu').click()">
    ...
    <section id=home class="intro main-bg section">
        <div class="main-content intro-content">
            ...
            <div class="intro-img">
                <img src="javascriptimg.svg" alt="logo de html, css e js">
            </div>
    ...
    <div class="main-content grid-one-content">
      ...
      <div class="grid">
        <div class="gallery-img">
          <img src="https://www.pousadadossonhos.com.br/wp-content/uploads/2017/09/326376106_926101335260132_4384309986089164988_n-360x360.jpg" 
          alt="random beach" >
        </div>
        <div class="gallery-img">
          <img src="https://aramis-wp.s3.us-west-2.amazonaws.com/2023/03/Capa-QuadradaNiver-RIO-360x360.jpg" 
          alt="rio de janeiro" >
        </div>
        <div class="gallery-img">
          <img src="https://www.sony.eu/alphauniverse/assets/resized/2020/11/ole-salomonsen-sony-alpha-7RM3-aurora-over-mountains-in-tromso-360x360-1_square_360x360.jpg" 
          alt="paisagem" >
        </div>
        <div class="gallery-img">
          <img src="https://aramis-wp.s3.us-west-2.amazonaws.com/2023/03/Capa-QuadradaRecife-360x360.jpg" 
          alt="recife" >
        </div>
        <div class="gallery-img">
          <img src="https://media.triumphmotorcycles.co.uk/image/upload/f_auto/q_auto:eco/sitecoremedialibrary/media-library/images/motorcycles/modern-classics/t%20series/scrambler%20400%20x/scrambler%20400%20x%20family%20page/scrambler-400-x-my24-family-acc-card-360x360.jpg" 
          alt="biker" >
        </div>
        <div class="gallery-img">
          <img src="https://www.maiseuropa.com.br/media/images/blog_post/O_Castelo_de_Hohenzollern_-_Mais_Europa_Blog.jpg"
          width="360" 
          height="360" 
          alt="Castelo" >
        </div>
  ...
  <section id="grid-two" class="grid-one main-bg section">
    ...
    <footer id="footer" class="footer white-bg">
      <p>Feito com ♥ por Thiago Yanagimori</p>
    </footer>
...
.menu{
    ...
    right: 0;
    width: 100%;
    border-bottom: var(--light-gray-color) 0.1rem solid;
    z-index: 1;
}
